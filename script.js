document.addEventListener('DOMContentLoaded', () => {
  ...
  regions.set('AltaiT', {name: 'Алтайский край', timezone: 7, end_workday: 22, start_workday: 9 });
  ...
  regions.set('Bashkortostan', {name: 'Башкортостан', timezone: 5, end_workday: 23, start_workday: 8 });
  regions.set('Belgorod', {name: 'Белгородская обл.', timezone: 3, end_workday: 22, start_workday: 10 });
  regions.set('Bryansk', {name: 'Брянская обл.', timezone: 3, end_workday: 22, start_workday: 8 });
  regions.set('Buryatia', {name: 'Бурятия', timezone: 8, end_workday: 21, start_workday: 9 });
  regions.set('Volgograd', {name: 'Волгоградская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Vologda', {name: 'Вологодская обл.', timezone: 3, end_workday: 14, start_workday: 12, end_holiday: 23, start_holiday: 8 });
  regions.set('Voronezh', {name: 'Воронежская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Vladimir', {name: 'Владимирская обл.', timezone: 3, end_workday: 21, start_workday: 9 });
  ...
  regions.set('Ivanovo', {name: 'Ивановская обл.', timezone: 3, end_workday: 21, start_workday: 9 });
  regions.set('Ingushetia', {name: 'Ингушетия', timezone: 3, end_workday: 20, start_workday: 10 });
  regions.set('Irkutsk', {name: 'Иркутская обл.', timezone: 8, end_workday: 21, start_workday: 9 });
  ...
  regions.set('Kemerovo', {name: 'Кемеровская обл.', timezone: 7, end_workday: 23, start_workday: 8 });
  regions.set('Kirov', {name: 'Кировская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Komi ', {name: 'Коми', timezone: 3, end_workday: 22, start_workday: 8 });
  regions.set('Kostroma', {name: 'Костромская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Krasnodar', {name: 'Краснодарский край', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Krasnoyarsk', {name: 'Красноярский край', timezone: 7, end_workday: 23, start_workday: 8 });
  regions.set('Crimea', {name: 'Крым', timezone: 3, end_workday: 23, start_workday: 10 });
  regions.set('Kurgan', {name: 'Курганская обл.', timezone: 5, end_workday: 22, start_workday: 8 });
  regions.set('Kursk', {name: 'Курская обл.', timezone: 3, end_workday: 22, start_workday: 8 });
  regions.set('Leningrad', {name: 'Ленинградская обл.', timezone: 3, end_workday: 22, start_workday: 11 });
  regions.set('Lipetsk', {name: 'Липецкая обл.', timezone: 3, end_workday: 21, start_workday: 9 });
  regions.set('Magadan', {name: 'Магаданская обл.', timezone: 11, end_workday: 22, start_workday: 10 });
  regions.set('Mari El', {name: 'Марий Эл', timezone: 3, end_workday: 22, start_workday: 9 });
  regions.set('Mordovia', {name: 'Мордовия', timezone: 3, end_workday: 22, start_workday: 10 });
  regions.set('Moscow', {name: 'Москва', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('MoscowR', {name: 'Московская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Murmansk', {name: 'Мурманская обл.', timezone: 3, end_workday: 21, start_workday: 11 });
  regions.set('Nenets', {name: 'Ненецкий АО', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Nizhny Novgorod', {name: 'Нижегородская обл.', timezone: 3, end_workday: 22, start_workday: 9 });
  regions.set('Novgorod', {name: 'Новгородская обл.', timezone: 3, end_workday: 22, start_workday: 8 });
  regions.set('Novosibirsk', {name: 'Новосибирская обл.', timezone: 7, end_workday: 22, start_workday: 9 });
  ...
  regions.set('Perm', {name: 'Пермский край', timezone: 5, end_workday: 23, start_workday: 8 });
  ...
  regions.set('Rostov', {name: 'Ростовская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Ryazan', {name: 'Рязанская обл.', timezone: 3, end_workday: 22, start_workday: 8 });
  regions.set('Samara', {name: 'Самарская обл.', timezone: 4, end_workday: 23, start_workday: 8 });
  ...
  regions.set('Sakhalin', {name: 'Сахалинская обл.', timezone: 11, end_workday: 22, start_workday: 8 });
  regions.set('Sverdlovsk', {name: 'Свердловская обл.', timezone: 5, end_workday: 23, start_workday: 8 });
  regions.set('Sevastopol', {name: 'Севастополь', timezone: 3, end_workday: 22, start_workday: 8 });
  regions.set('North Ossetia', {name: 'Северная Осетия', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Smolensk', {name: 'Смоленская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Stavropol', {name: 'Ставропольский край', timezone: 3, end_workday: 22, start_workday: 10 });
  regions.set('Tambov', {name: 'Тамбовская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Tatarstan', {name: 'Татарстан', timezone: 3, end_workday: 23, start_workday: 8 });
  ...
  regions.set('Tyumen', {name: 'Тюменская обл.', timezone: 5, end_workday: 21, start_workday: 8 });
  regions.set('Udmurtian', {name: 'Удмуртия', timezone: 4, end_workday: 22, start_workday: 10 });
  regions.set('Ulyanovsk', {name: 'Ульяновская обл.', timezone: 4, end_workday: 23, start_workday: 8 });
  regions.set('Khabarovsk', {name: 'Хабаровский край', timezone: 10, end_workday: 22, start_workday: 10 });
  regions.set('Khakassia', {name: 'Хакасия', timezone: 7, end_workday: 23, start_workday: 8 });
  regions.set('Khanty-Mansi', {name: 'Ханты-Мансийский АО', timezone: 5, end_workday: 20, start_workday: 8 });
  regions.set('Chelyabinsk', {name: 'Челябинская обл.', timezone: 5, end_workday: 23, start_workday: 8 });
  regions.set('Chechen', {name: 'Чечня', timezone: 3, end_workday: 23, start_workday: 8 });
  regions.set('Chuvash', {name: 'Чувашия', timezone: 3, end_workday: 23, start_workday: 8 });
  ...
  regions.set('Yaroslavl', {name: 'Ярославская обл.', timezone: 3, end_workday: 23, start_workday: 8 });
